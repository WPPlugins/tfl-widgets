	 ...
	 */
	 ...
	 public function func_tube_updates( $atts ) {
		...
		if ($atts['width'] == "variable") {
			return '<script language="JavaScript" src="https://www.tfl.gov.uk/tfl/syndication/widgets/serviceboard/embeddable/serviceboard-iframe-stretchy.js"></script>';
		} else {
	 		return '<div style="width:' . $atts['width'] . '"><script language="JavaScript" src="https://www.tfl.gov.uk/tfl/syndication/widgets/serviceboard/embeddable/serviceboard-iframe-stretchy.js"></script></div>';
		}
	 }
	 ...
	 public function func_tube_map( $atts ) {
		...
		if ($atts['width'] == "variable") {
			return '<script language="JavaScript" src="https://www.tfl.gov.uk/tfl/syndication/widgets/tubemap/tubemap-iframe-stretchy.js"></script>';
		} else {
	 		return '<div style="width' . $atts['width'] . '"><script language="JavaScript" src="https://www.tfl.gov.uk/tfl/syndication/widgets/tubemap/tubemap-iframe-stretchy.js"></script></div>';
		}
	 }
